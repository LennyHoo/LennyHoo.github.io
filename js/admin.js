var vm = new Vue({
    ...
    methods: {
        ...
        summit(){
            ...
            this.$http.post("http://www.aspendove.xyz:8000/summit", 
        ...
        add_a_tag(){
            ...
            this.$http.post("http://www.aspendove.xyz:8000/add_tag", {file_name: file_name, tag: this.tag, nickname: this.nickname}
                , {emulateJSON: true}).then(msg => {
                    content = msg.body;
                    if(content=="ok"){
                        this.get_tags();
